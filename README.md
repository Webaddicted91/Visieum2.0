...
<i><p>An online platform providing comprehensive information on nearby Museum   and Museum facilities!</p></i>
...
<table align="center">
    ...
    <tbody>
         <tr>
            <td><img alt="Stars" src="https://img.shields.io/github/stars/Webaddicted91/Visieum2.0-?style=flat&logo=github"/></td>
             <td><img alt="Forks" src="https://img.shields.io/github/forks/Webaddicted91/Visieum2.0-?style=flat&logo=github"/></td>
            <td><img alt="Issues" src="https://img.shields.io/github/issues/Webaddicted91/Visieum2.0-?style=flat&logo=github"/></td>
            <td><img alt="Open Pull Requests" src="https://img.shields.io/github/issues-pr/Webaddicted91/Visieum2.0-?style=flat&logo=github"/></td>
           <td><img alt="Closed Pull Requests" src="https://img.shields.io/github/issues-pr-closed/Webaddicted91/Visieum2.0-?style=flat&color=critical&logo=github"/></td>
        </tr>
    </tbody>
</table>
</div>
...
It is an online platform which enables you to get information about your nearest Museum and Museum facilities including important information like ticket availablity and price. It aims to address Museum-related issues with the help of a Chatbot. </p>
...
<p style="font-family:var(--ff-philosopher);">To contribute to the Visieum2.0 repository, follow these steps:</p>
...
2. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/<your-github-username>/Visieum2.0
   ```
3. **Add a remote upstream:**
   ```bash
   git remote add upstream https://github.com/original-owner-username/Visieum2.0
   ```
...
To contribute to the Visieum2.0 repository using GitHub Desktop, follow these steps:
...
<a href="https://github.com/Webaddicted91/Visieum2.0-/graphs/contributors">
<img src="https://contributors-img.web.app/image?repo=Webaddicted91/Visieum2.0-"/>
